...
class SparseHeadv3(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is SparseHeadv3):
        ...
        super(SparseHeadv3, self).__init__(num_classes, in_channels, init_cfg = init_cfg)
    ...
    def forward(self, img_metas, 
        ...
        if self.using_queries:
            ...
            self.num_query = reference_points.size(1)
            # print(reference_points.size(), self.num_query)

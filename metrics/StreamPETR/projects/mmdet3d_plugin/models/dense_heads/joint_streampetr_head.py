...
class QueryRoIHeadv2(BaseModule):
    ...
    def __init__(self,
        ...
        super(QueryRoIHeadv2, self).__init__(init_cfg)
...
@HEADS.register_module()
class JointStreamPETRHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is JointStreamPETRHead):
        ...
        super(JointStreamPETRHead, self).__init__(num_classes, in_channels, init_cfg = init_cfg)
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is JointStreamPETRHead:
            convert_dict = {

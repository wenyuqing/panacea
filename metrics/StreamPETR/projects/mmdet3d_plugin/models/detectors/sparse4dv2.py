...
class Sparse4Dv2(MVXTwoStageDetector):
    """Sparse4D."""
    ...
    def __init__(self,
        ...
        super(Sparse4Dv2, self).__init__(pts_voxel_layer, pts_voxel_encoder,
    ...
    def forward_train(self,
        ...
        if self.img_roi_head is None:
            ...
            # """
            # recall = len(torch.unique(res_proposals['proposal_match_idxs'])) / max(gt_bboxes_3d[0].tensor.shape[0], 1.0)
